...
func game() {
	...
	characters := []mapCharacter{
		{name: "MARCHAND", rect: rl.Rectangle{X: 136, Y: 312, Width: 48, Height: 48}, color: rl.Gold, animation: pnjAnimations["MARCHAND"]},
		{name: "CHARCUDOC", rect: rl.Rectangle{X: 411, Y: 242, Width: 48, Height: 48}, color: rl.Purple, animation: pnjAnimations["CHARCUDOC"]},
		{name: "GUERRE DE GANG", rect: rl.Rectangle{X: 644, Y: 306, Width: 72, Height: 72}, color: rl.Red, animation: pnjAnimations["GUERRE DE GANG"]},
	}
