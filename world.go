...
func drawWorldDecor() {
	...
	// Décor fixe du quartier. Les positions restent hors des zones de collision du joueur.
	drawWorldObject(worldArt.deco[0], 28, 322, 1.35)
	drawWorldObject(worldArt.deco[1], 285, 374, 1.1)
	drawWorldObject(worldArt.deco[2], 500, 322, 1.15)
	drawWorldObject(worldArt.deco[3], 745, 288, 1.05)
	drawWorldObject(worldArt.deco[4], 20, 205, 1.4)
	drawWorldObject(worldArt.deco[5], 555, 180, 1.25)
	drawWorldObject(worldArt.deco[6], 870, 395, 1.3)
	drawWorldObject(worldArt.deco[7], 690, 405, 1.25)
}
